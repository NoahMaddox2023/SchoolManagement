...
namespace SchoolManagement.Controllers
{
    ...
    public class LecturersController : Controller
    {
        ...
        public async Task<ActionResult> Create([Bind(Include = "Id,LecturerFirstName,LecturerLastname")] Lecturer lecturer)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Edit([Bind(Include = "Id,LecturerFirstName,LecturerLastname")] Lecturer lecturer)
        {
            if (ModelState.IsValid)
            {
