...
namespace SchoolManagement.Controllers
{
    public class EnrollmentsController : Controller
    {
        ...
        public ActionResult Create()
        {
            ...
            ViewBag.LecturerID = new SelectList(db.Lecturers, "Id", "LecturerFirstName");
        ...
        public async Task<ActionResult> Create([Bind(Include = "EnrollmentID,Grade,CourseID,StudentID,LecturerID")] Enrollment enrollment)
        {
            ...
            ViewBag.LecturerID = new SelectList(db.Lecturers, "Id", "LecturerFirstName", enrollment.LecturerID);
            return View(enrollment);
        }

        [HttpPost]
        public async Task<JsonResult> AddStudent([Bind(Include = "CourseID,StudentID,LecturerID")] Enrollment enrollment)
        {
            try
            {
                var isEnrolled = db.Enrollments.Any(q => q.CourseID == enrollment.CourseID && q.StudentID == enrollment.StudentID && q.LecturerID == enrollment.LecturerID);
                if (ModelState.IsValid && !isEnrolled)
                {
                    db.Enrollments.Add(enrollment);
                    await db.SaveChangesAsync();
                    return Json(new { IsSuccess = true, Message = "Student was added successfully." }, JsonRequestBehavior.AllowGet);
                }
        ...
        public JsonResult GetStudents(string term)
        {
            ...
            {
                Name = q.StudentFirstName + " " + q.StudentLastName,
                Id = q.StudentID
